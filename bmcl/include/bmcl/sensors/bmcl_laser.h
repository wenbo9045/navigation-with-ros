...
// Laser sensor data
class BMCLLaserData : public BMCLSensorData
{
  public:
    BMCLLaserData () {ranges=NULL;};
    virtual ~BMCLLaserData() {delete [] ranges;};
...
class BMCLLaser : public BMCLSensor
{
  // Default constructor
  public: BMCLLaser(size_t max_beams, map_t* map);

  public: virtual ~BMCLLaser(); 
  ...
  private: static double BeamModel(BMCLLaserData *data, 
                                   pf_sample_set_t* set);
  // Determine the probability for the given pose
  private: static double LikelihoodFieldModel(BMCLLaserData *data, 
                                              pf_sample_set_t* set);

  // Determine the probability for the given pose - more probablistic model 
  private: static double LikelihoodFieldModelProb(BMCLLaserData *data, 
					     pf_sample_set_t* set);
