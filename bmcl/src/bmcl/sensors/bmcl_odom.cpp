...
#include "bmcl/sensors/bmcl_odom.h"
...
////////////////////////////////////////////////////////////////////////////////
// Default constructor
BMCLOdom::BMCLOdom() : BMCLSensor()
{
  this->time = 0.0;
}

void
BMCLOdom::SetModelDiff(double alpha1, 
                       double alpha2, 
                       double alpha3, 
                       double alpha4)
{
...
void
BMCLOdom::SetModelOmni(double alpha1, 
                       double alpha2, 
                       double alpha3, 
                       double alpha4,
                       double alpha5)
...
void
BMCLOdom::SetModel( odom_model_t type,
                    double alpha1,
                    double alpha2,
                    double alpha3,
                    double alpha4,
...
bool BMCLOdom::UpdateAction(pf_t *pf, BMCLSensorData *data)
{
  BMCLOdomData *ndata;
  ndata = (BMCLOdomData*) data;
